    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        <div className="flex flex-col justify-center">
          ...
          <h1 
            className={cn(
              "text-4xl md:text-5xl lg:text-6xl font-bold leading-tight md:leading-tight lg:leading-tight text-gray-900 mb-6",
              isVisible ? "opacity-100 translate-y-0 transition-all duration-700 delay-200" : "opacity-0 translate-y-8"
            )}
          >
          ...
          <p 
            className={cn(
              "text-xl text-gray-600 mb-8 max-w-lg",
              isVisible ? "opacity-100 translate-y-0 transition-all duration-700 delay-300" : "opacity-0 translate-y-8"
            )}
          >
            Add Brooklyn to WhatsApp and never worry about scheduling meetings again. 
            Forward your meeting details, and Brooklyn handles the rest.
          </p>
          
          <div 
            className={cn(
              "flex flex-col sm:flex-row gap-4 mb-10",
              isVisible ? "opacity-100 translate-y-0 transition-all duration-700 delay-400" : "opacity-0 translate-y-8"
            )}
          >
            <Link to="/login">
          ...
          <div 
            className={cn(
              ...
              isVisible ? "opacity-100 translate-y-0 transition-all duration-700 delay-500" : "opacity-0 translate-y-8"
            )}
          >
        ...
        >
            ...
            <div className="absolute inset-0 flex flex-col">
              ...
              <div className="flex-grow bg-gradient-to-b from-gray-50 to-gray-100 p-3 overflow-hidden">
                <div className="flex flex-col space-y-3">
                  {/* Message bubbles */}
                  <div className="bg-white rounded-lg rounded-tl-none p-3 max-w-[80%] shadow-sm self-start animate-slide-in-right" style={{ animationDelay: '600ms' }}>
                    <p className="text-sm">Hi there! I'm Brooklyn, your personal calendar assistant.</p>
                  </div>
                  
                  <div className="bg-brooklyn-100 rounded-lg rounded-tr-none p-3 max-w-[80%] shadow-sm self-end animate-slide-in-left" style={{ animationDelay: '900ms' }}>
                    <p className="text-sm">I have a meeting with Alex tomorrow at 3pm about the new project.</p>
                  </div>
                  
                  <div className="bg-white rounded-lg rounded-tl-none p-3 max-w-[80%] shadow-sm self-start animate-slide-in-right" style={{ animationDelay: '1200ms' }}>
                    <p className="text-sm">Perfect! I've added "Project Meeting with Alex" to your calendar tomorrow at 3:00 PM.</p>
                  </div>
                  
                  <div className="bg-white rounded-lg rounded-tl-none p-3 max-w-[80%] shadow-sm self-start animate-slide-in-right" style={{ animationDelay: '1500ms' }}>
                    <p className="text-sm">Would you like me to send a reminder 15 minutes before?</p>
                  </div>
                  
                  <div className="bg-brooklyn-100 rounded-lg rounded-tr-none p-3 max-w-[80%] shadow-sm self-end animate-slide-in-left" style={{ animationDelay: '1800ms' }}>
                    <p className="text-sm">Yes, please!</p>
                  </div>
                  
                  <div className="bg-white rounded-lg rounded-tl-none p-3 max-w-[80%] shadow-sm self-start animate-slide-in-right" style={{ animationDelay: '2100ms' }}>
          ...
          <div className="absolute -bottom-8 -left-8 w-16 h-16 bg-blue-100 rounded-full opacity-40 animate-float" style={{ animationDelay: '1s' }}></div>
        </div>
      </div>
    </section>
  );
